package com.bank.islamic.hibahdiscretionarygift.model;
...
/**
 * The BIAN control record for this service domain: "Hibah Award Procedure".
 *
 ...
 * to its asset type (Hibah Award). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Hibah Award Procedure";
